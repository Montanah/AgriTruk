...
const variants = {
  ...
  'secondary': { background: { r: 34, g: 197, b: 94, alpha: 1 }, name: 'secondary' }, // Green
  'accent': { background: { r: 168, g: 85, b: 247, alpha: 1 }, name: 'accent' }, // Purple
  'surface': { background: { r: 107, g: 114, b: 128, alpha: 1 }, name: 'surface' }, // Gray
  'light': { background: { r: 248, g: 250, b: 252, alpha: 1 }, name: 'light' }, // Light gray
  'gradient': { background: { r: 255, g: 255, b: 255, alpha: 1 }, name: 'gradient' }, // White
};
...
async function generateProfessionalTrukIcons() {
  ...
  try {
    ...
    console.log('3. The professional TRUK logo will appear on device home screens');
  } catch (error) {
    console.error('❌ Error generating Professional TRUK icons:', error.message);
    process.exit(1);
  }
}
