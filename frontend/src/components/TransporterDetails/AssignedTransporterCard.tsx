...
export const AssignedTransporterCard: React.FC<AssignedTransporterCardProps> = ({
  transporter,
  onCall,
  onMessage,
  onViewProfile,
  ...
  const handleCall = () => {
    if (onCall) {
      ...
      Alert.alert('Call Transporter', `Call ${transporter.name} at ${transporter.phone}`);
    }
  };
  ...
  const handleMessage = () => {
    if (onMessage) {
      ...
      Alert.alert('Message Transporter', `Open chat with ${transporter.name}`);
    }
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.profileSection}>
          <Image
            source={{
              uri: transporter.profilePhoto || PLACEHOLDER_IMAGES.PROFILE_PHOTO_MEDIUM,
            }}
            style={styles.profilePhoto}
          />
          <View style={styles.profileInfo}>
            <Text style={styles.transporterName}>{transporter.name}</Text>
            {transporter.isCompanyDriver && transporter.company && (
