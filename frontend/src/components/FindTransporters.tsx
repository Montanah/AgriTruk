...
export type FindTransportersProps = {
  ...
  onBack?: () => void; // Callback to return to request form
};

const FindTransporters: React.FC<FindTransportersProps> = ({ requests, distance, accent = colors.primary, onSelect, onBack }) => {
