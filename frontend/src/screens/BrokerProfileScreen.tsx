            ...
            <View style={styles.helpSection}>
              <View style={styles.helpItem}>
                ...
                <View style={styles.helpItemContent}>
                  <Text style={styles.helpItemTitle}>Broker Services</Text>
                  <Text style={styles.helpItemDescription}>
                    1. Connect shippers with transporters{'\n'}
                    2. Manage consolidation requests{'\n'}
                    3. Track shipment progress{'\n'}
                    4. Handle payments and commissions
                  </Text>
                </View>
              </View>
              ...
              <View style={styles.helpItem}>
                ...
                <View style={styles.helpItemContent}>
                  <Text style={styles.helpItemTitle}>Analytics & Reports</Text>
                  <Text style={styles.helpItemDescription}>
                    Access detailed analytics about your broker performance, commission tracking, and business insights to optimize your operations.
                  </Text>
                </View>
              </View>
