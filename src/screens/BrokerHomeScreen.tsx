  ...
  const fetchBrokerStats = async () => {
    try {
      ...
      if (res.ok) {
        ...
        const bookings =
          (await unifiedBookingService?.getBookings("broker")) || [];
        ...
        try {
          const computed =
            await unifiedBookingService?.getBookingStats("broker");
          const bookings =
            (await unifiedBookingService?.getBookings("broker")) || [];
          ...
          if (computed) {
            setStats((prev) => ({
              ...prev,
              activeRequests:
                (computed.confirmed || 0) + (computed.inTransit || 0),
  ...
  const loadBrokerProfile = async () => {
    try {
      ...
      if (userDoc.exists()) {
        ...
        const photoUrl =
          userData?.profilePhotoUrl || userData?.profilePhoto || user?.photoURL;
        if (photoUrl) {
      ...
      <View style={styles.clientInfo}>
        ...
        <View style={styles.clientMeta}>
          <Text style={styles.clientRequests}>
            {item?.activeRequests || 0} active requests
          </Text>
          <Text style={styles.clientLastRequest}>
            Last: {item?.lastRequest || "Never"}
          </Text>
        </View>
      </View>
  ...
  return (
    <SafeAreaView style={styles.container}>
          ...
          <View style={styles.earningsCard}>
            ...
            <View style={styles.earningsBreakdown}>
              <Text style={styles.breakdownText}>
                From {stats.completedTrips} completed trips
              </Text>
              <Text style={styles.breakdownText}>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              ...
              <TouchableOpacity
                onPress={() => setShowClientDetailsModal(false)}
              >
                <Ionicons
                  name="close"
                  size={24}
              ...
              <>
                <View style={styles.clientDetailHeader}>
                  ...
                  <View style={styles.clientDetailInfo}>
                    ...
                    <Text style={styles.clientDetailCompany}>
                    ...
                    <View style={styles.verificationStatus}>
                      ...
                      <Text
                        style={[
                          ...
                          {
                            color: selectedClient.isVerified
                              ? colors.success
                              : colors.error,
                          },
                        ]}
                ...
                <View style={styles.clientDetailStats}>
                  <View style={styles.statItem}>
                    ...
                    <Text style={styles.clientDetailStatValue}>
      ...
      <BackgroundLocationDisclosureModal
        ...
        onAccept={async () => {
          console.log(
            "✅ BrokerHomeScreen: User accepted background location disclosure",
          );
          ...
          console.log("✅ BrokerHomeScreen: Background location consent saved");
        }}
        onDecline={async () => {
          console.log(
            "❌ BrokerHomeScreen: User declined background location disclosure",
          );
          ...
          console.log(
            "ℹ️ BrokerHomeScreen: Background location consent declined - app will use foreground-only tracking",
          );
        }}
      />
    </SafeAreaView>
