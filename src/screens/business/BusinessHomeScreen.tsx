...
const insights = [
  { label: 'Total Spent (30d)', value: 'KES 1.2M', icon: 'cash-multiple' },
  { label: 'Most Used Route', value: 'Nairobi → Mombasa', icon: 'map-marker-path' },
];
    ...
    <>
      <View style={{ flex: 1, backgroundColor: colors.background }}>
        ...
        <View style={styles.insightsRow}>
          {insights.map((ins) => (
            <Card key={ins.label} style={styles.insightCard}>
              <MaterialCommunityIcons name={ins.icon as any} size={24} color={colors.secondary} style={{ marginBottom: 6 }} />
