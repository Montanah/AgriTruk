...
const features = [
  {
    ...
    title: "agriTRUK",
    description:
      "For transporting farm goods and all types of agricultural products from farm to market.",
  ...
  },
  {
    ...
    title: "cargoTRUK",
    description:
      "For general cargo, logistics, and goods transportation of any kind.",
  ...
  },
  {
    ...
    graphic: (
      <MaterialCommunityIcons name="truck" size={60} color={"#FF8C00"} />
    ),
    title: "Transporter",
    description:
      "For transport companies and businesses in the logistics industry to manage fleets, drivers, and operations",
    color: "#FF8C00",
    accent: "#FF8C00",
  },
  {
...
const WelcomeScreen = () => {
  ...
  const logoSize = isTablet
    ? isLandscape
      ? Math.min(screenWidth * 0.15, 150)
      : Math.min(screenWidth * 0.25, 200)
    : screenWidth * 0.36;
