          ...
          <View style={styles.formCard}>
            ...
            <View style={styles.switchRow}>
              <TouchableOpacity
                style={[
                  styles.switchBtn,
                  loginMode === "email" && styles.switchBtnActive,
                ]}
              ...
              >
                <Text
                  style={[
                    ...
                    loginMode === "email" && styles.switchBtnTextActive,
                  ]}
                >
                  Email
                </Text>
              ...
              <TouchableOpacity
                style={[
                  styles.switchBtn,
                  loginMode === "phone" && styles.switchBtnActive,
                ]}
              ...
              >
                <Text
                  style={[
                    styles.switchBtnText,
                    loginMode === "phone" && styles.switchBtnTextActive,
                  ]}
                >
                  Phone
                </Text>
                  ...
                  if (loginMode === "email") {
                    ...
                    try {
                      ...
                      const driverResponse = await fetch(
                        `${process.env.EXPO_PUBLIC_API_URL || "https://agritruk.onrender.com"}/api/companies/driver/${userCredential.user.uid}`,
                        {
                      ...
                      console.log(
                        "Not a company driver, proceeding with normal flow",
                      );
                    }
                    ...
                    try {
                      ...
                      const response = await fetch(
                        `${process.env.EXPO_PUBLIC_API_URL || "https://agritruk.onrender.com"}/api/auth/get-user-by-phone`,
                        {
                          method: "POST",
                          headers: {
                      ...
                      if (!userData.email) {
                        setLoading(false);
                        setError(
                          "This phone number is not associated with an email. Please contact support.",
                        );
                        return;
                      }
                      ...
                      if (!userData.phoneVerified) {
                        ...
                        console.log(
                          "Phone not verified - resending verification code",
                        );
                        ...
                        try {
                          ...
                          console.log(
                            "Phone verification code resent - navigating to PhoneOTPScreen",
                          );
                          ...
                          console.error(
                            "Error resending phone verification code:",
                            resendError,
                          );
                          setLoading(false);
                          setError(
                            "This phone number is not verified. Verification code could not be sent. Please try again.",
                          );
                          return;
                        }
                      }
                      ...
                      console.log(
                        "Attempting Firebase Auth with email:",
                        userData.email,
                      );
                      const userCredential = await signInWithEmailAndPassword(
                        auth,
                      ...
                      setLoading(false);
                      let apiErrorMessage =
                        "Unable to verify phone number. Please try again or use email login.";
